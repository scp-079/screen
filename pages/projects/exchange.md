...
3. 发出提示，附带按钮，点击则可开始引导程序，并分配唯一申请编号
4. 引导程序主要介绍各机器人的默认及可选规则，用户点击按钮选择是否启用该机器人后，询问下一个机器人
5. 引导程序简要介绍隐私及相关政策，用户同意后方可继续
6. 引导程序结束后，取消该用户禁言，提示用户发送有效的入群链接
7. 提示用户等待 MANAGE 的回复，将回复结果更新至原有引导消息中
8. 项目等级为：**Safe**
...
7. 在 MANAGE 群组中提供手动移除用户、频道黑名单的功能
8. 在 MANAGE 群组中提供手动添加用户、频道白名单的功能
...
情形 8：向 USER 发送协助请求，调用 delete all 功能，删除某用户全部消息
